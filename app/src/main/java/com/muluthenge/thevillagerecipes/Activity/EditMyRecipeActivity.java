package com.muluthenge.thevillagerecipes.Activity;
...
import com.muluthenge.thevillagerecipes.Adapter.AllRecipesAdapter;
import com.muluthenge.thevillagerecipes.Adapter.EditIngredientAdapter;
import com.squareup.picasso.Picasso;
import com.muluthenge.thevillagerecipes.Manager.KeysManager;
import com.muluthenge.thevillagerecipes.Manager.PermissionManager;
...
public class EditMyRecipeActivity extends AppCompatActivity {
    private TextView editEngredientsTextView;
    ...
    private Button save;
//  jupun edit
    private com.muluthenge.thevillagerecipes.Adapter.EditIngredientAdapter EditIngredientAdapter;
    private Button editIngredientsBtn;
    private Button editStepsBtn;
...
//      jupun edit
        editEngredientsTextView = findViewById(R.id.editIngredientsView);
//        editIngredientsBtn = (Button)findViewById(R.id.editIngredients);
//        editStepsBtn = (Button)findViewById(R.id.editSteps);
...
//        jupun edit
        ...
        RecyclerView quickRecipesRecyclerView = (RecyclerView) findViewById(R.id.edit_ingredient_recycler);
        quickArrayList = new ArrayList<>();
        EditIngredientAdapter = new EditIngredientAdapter(this, quickArrayList);
        quickRecipesRecyclerView.setAdapter(EditIngredientAdapter);
...
//        editIngredientsBtn.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent steps = new Intent(EditMyRecipeActivity.this, EditIngredientsActivity.class);
//                startActivity(steps);
//                finish();
//            }
//        });
//        editStepsBtn.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startActivity(new Intent(EditMyRecipeActivity.this, EditStepsActivity.class));
//                finish();
//            }
//        });
